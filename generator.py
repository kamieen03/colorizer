...
class UNet(nn.Module):
    def __init__(self, nfc=32):
        ...
        self.down1 = Down(1, 1*nfc, self.norm, self.dropout)
        self.down2 = Down(1*nfc, 2*nfc, self.norm, self.dropout)
        self.down3 = Down(2*nfc, 4*nfc, self.norm, self.dropout)
        self.down4 = Down(4*nfc, 8*nfc, self.norm, self.dropout)
        self.down5 = Down(8*nfc, 8*nfc, self.norm, self.dropout)
        self.up1   = Up(16*nfc, 4*nfc, self.norm, self.dropout)
...
class Down(nn.Module):
    def __init__(self, inc, outc, norm, dropout):
        super().__init__()
        self.norm = norm
